...
export const mockWeb3DeFi: Stock[] = [
  { 
    id: 'w3df_uni', symbol: 'UNI', name: 'Uniswap', price: 11.50, change: 0.80, changePercent: 7.48, exchange: 'Crypto',
  ...
  { 
    id: 'w3df_link', symbol: 'LINK', name: 'Chainlink', price: 18.20, change: 0.82, changePercent: 4.71, exchange: 'Crypto',
  ...
  { 
    id: 'w3df_aave', symbol: 'AAVE', name: 'Aave', price: 110.30, change: 5.40, changePercent: 5.15, exchange: 'Crypto',
