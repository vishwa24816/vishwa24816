...
export const mockStockFuturesForWatchlist: Stock[] = [
  ...
  { id: 'futHDFCBANK', symbol: 'HDFCBANKJANFUT', name: 'HDFCBANK Jan Future', price: 1615.00, change: 7.50, changePercent: 0.47, exchange: 'NFO' },
  { id: 'futICICIBANK', symbol: 'ICICIBANKJANFUT', name: 'ICICIBANK Jan Future', price: 930.20, change: -2.30, changePercent: -0.25, exchange: 'NFO' },
];
